module github.com/plerionio/komet-controller
...
require (
	...
	github.com/knative/pkg v0.0.0-20190703054432-db778775199d // indirect
	...
	knative.dev/pkg v0.0.0-20190703054432-db778775199d // indirect
